      ...
      <div className="flex flex-col px-4">
        <div className="mx-auto w-full max-w-screen-2xl py-8 lg:my-4">
          ...
          <div className="flex flex-col lg:flex-row-reverse">
            <div className="flex flex-col py-4 lg:py-0 lg:pl-16">
              <p className="dmtims-subheading pb-16 text-[#28314A]">
              ...
              <p className="dmtims-subtitle text-[#EE3768]">
                Eligibility criteria
              </p>
              <ol className="list-decimal px-6 pb-4">
                {criterias.map((item) => (
                  <li
                    key={item.id}
