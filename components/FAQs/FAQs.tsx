                  ...
                  <div onClick={() => setIsOpen(!open)}>
                    <Disclosure.Button className="flex w-full bg-[#F2F2F2] px-4 py-2">
                      <p className="dmtims-subheading pb-0 text-left text-[#28314A]">
                        ...
                        required to get into the DMTIMS PGDM program?
                      </p>
              ...
              {({ open }) => (
                <>
                  <div onClick={() => setIsOpen(!open)}>
                    <Disclosure.Button className="flex w-full bg-[#F2F2F2] px-4 py-2">
                      <p className="dmtims-subheading pb-0 text-left text-[#28314A]">
                        4. Can I apply for PGDM program if I have not appeared
              ...
              {({ open }) => (
                <>
                  <div onClick={() => setIsOpen(!open)}>
                    <Disclosure.Button className="flex w-full bg-[#F2F2F2] px-4 py-2">
                      <p className="dmtims-subheading pb-0 text-left text-[#28314A]">
                        6. Is the PGDM Course at DMTIMS an AICTE approved
                        course?
                      </p>
                      <div className="ml-auto flex items-center">
                        <PlusIcon
                  ...
                  >
                    ...
                    >
                      <p className="dmtims-text mx-6 pb-1 text-[#28314A]">
                        Yes: The PGDM Course at DMTIMS is approved by AICTE &
              ...
              {({ open }) => (
                <>
                  <div onClick={() => setIsOpen(!open)}>
                    <Disclosure.Button className="flex w-full bg-[#F2F2F2] px-4 py-2">
                      <p className="dmtims-subheading pb-0 text-left text-[#28314A]">
                        7. What is the intake of students in DMTIMS PGDM
                        program?
                      </p>
                      <div className="ml-auto flex items-center">
                        <PlusIcon
              ...
              {({ open }) => (
                <>
                  ...
                  >
                    ...
                    >
                      <p className="dmtims-text mx-6 pb-1 text-[#28314A]">
                        Mode of Payment for PGDM admission application form for
              ...
              {({ open }) => (
                <>
                  <div onClick={() => setIsOpen(!open)}>
                    <Disclosure.Button className="flex w-full bg-[#F2F2F2] px-4 py-2">
                      <p className="dmtims-subheading pb-0 text-left text-[#28314A]">
                        10. What is the PGDM Fee Payment Schedule?
                      </p>
                      <div className="ml-auto flex items-center">
                        <PlusIcon
                          className={`${
                  ...
                  >
                    ...
                    >
                      <p className="dmtims-text mx-6 pb-4 text-[#28314A]">
                        Below mentioned are two options to pay DMTIMS PGDM Fees.
                      </p>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="dmtims-text mx-6 text-[#28314A]">
                        ...
                        assessments, will comprise the PGDM program admission
                        screening process.
                      </p>
                      <p className="dmtims-text mx-6 text-[#28314A]">
              ...
              {({ open }) => (
                <>
                  <div onClick={() => setIsOpen(!open)}>
                    <Disclosure.Button className="flex w-full bg-[#F2F2F2] px-4 py-2">
                      <p className="dmtims-subheading pb-0 text-left text-[#28314A]">
                        19. What is the fee structure for DMTIMS PGDM program?
                      </p>
                      <div className="ml-auto flex items-center">
                        <PlusIcon
                          className={`${
                  ...
                  >
                    ...
                    >
                      <p className="dmtims-text mx-6 pb-1 text-[#28314A]">
                        The fee structure for the PGDM course for the academic
                        year 2023- 25 is mentioned separately on the DMTIMS
                        Website www.dmtims.edu.in and the PGDM Brochure.{" "}
                      </p>
                    </Disclosure.Panel>
                  </Transition>
                </>
              ...
              {({ open }) => (
                <>
                  <div onClick={() => setIsOpen(!open)}>
                    <Disclosure.Button className="flex w-full bg-[#F2F2F2] px-4 py-2">
                      <p className="dmtims-subheading pb-0 text-left text-[#28314A]">
                        34. What is the date of commencement of classes for PGDM
                        programs?
                      </p>
                      <div className="ml-auto flex items-center">
                        <PlusIcon
              ...
              {({ open }) => (
                <>
                  <div onClick={() => setIsOpen(!open)}>
                    <Disclosure.Button className="flex w-full bg-[#F2F2F2] px-4 py-2">
                      <p className="dmtims-subheading pb-0 text-left text-[#28314A]">
                        35. What term does the PGDM Program follow?
                      </p>
                      <div className="ml-auto flex items-center">
                        <PlusIcon
                          className={`${
                  ...
                  >
                    ...
                    >
                      <p className="dmtims-text mx-6 pb-1 text-[#28314A]">
                        The PGDM program follows the trimester pattern. The
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="dmtims-text mx-6 pb-4 text-[#28314A]">
                        DMTIMS PGDM BATCH 2023-25 Admissions
                      </p>
                      <p className="dmtims-text mx-6 pb-4 text-[#28314A]">
